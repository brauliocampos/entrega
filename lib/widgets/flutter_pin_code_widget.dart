...
import 'package:user_web/widgets/flutterwave_otp_widget.dart';
// import 'package:flutter_dotenv/flutter_dotenv.dart';

class FlutterPinCodeWidget extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<FlutterPinCodeWidget> createState() =>
      _FlutterPinCodeWidgetState();
}

class _FlutterPinCodeWidgetState extends ConsumerState<FlutterPinCodeWidget> {
  List data = [];
  List cardDetails = [];
  String flwRef = '';
  String pin = '';
    ...
    FirebaseFirestore.instance
      ...
      if (mounted) {
        setState(() {
          ...
          publicKey = value.data()!['Public key'];
          secretKey = value.data()!['Secret Key'];
          encryptionKey = value.data()!['Encryption Key'];
        });
      }
    });
  }
