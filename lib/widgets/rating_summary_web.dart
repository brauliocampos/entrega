...
class RatingSummaryWeb extends StatefulWidget {
  final num totalNumberOfUserRating;
  final num totalRating;
  final List<RatingModel> ratings;
  const RatingSummaryWeb(
      {super.key,
  ...
  @override
  State<RatingSummaryWeb> createState() => _RatingSummaryWebState();
}

class _RatingSummaryWebState extends State<RatingSummaryWeb> {
  num rating1 = 0;
  num rating2 = 0;
  num rating3 = 0;
  num rating4 = 0;
                      ...
                      RichText(
                        text: TextSpan(
                          ...
                          style: DefaultTextStyle.of(context).style.copyWith(
                                fontSize:
                                    60.r, // Default font size for unstyled text
                              ),
                          children: <TextSpan>[
                            TextSpan(
                              text:
