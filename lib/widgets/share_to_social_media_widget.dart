...
class ShareToSocials extends StatefulWidget {
  ...
  final String module;
  const ShareToSocials({super.key, required this.productID, required this.module});
...
class _ShareToSocialsState extends State<ShareToSocials> {
  void shareToFacebook() async {
    ...
    final facebookShareUrl =
        'https://www.facebook.com/sharer/sharer.php?u=$domainUrl/${widget.module.toLowerCase()}/product-detail/${widget.productID}';
  ...
  void shareToTwitter() async {
    ...
    final encodedUrl = Uri.encodeComponent(
        '$domainUrl/${widget.module.toLowerCase()}/product-detail/${widget.productID}');
  ...
  void shareToInstagram() async {
    ...
    if (await canLaunchUrl(Uri.parse(instagramUrl))) {
      ...
      await launchUrl(Uri.parse(
          '$instagramUrl?text=Olivette Store&url=$domainUrl/${widget.module.toLowerCase()}/product-detail/${widget.productID}'));
    } else {
  ...
  void launchWhatsApp() async {
    var whatsappUrl = "https://api.whatsapp.com/send?text=$domainUrl//${widget.module.toLowerCase()}/product-detail/${widget.productID}";
